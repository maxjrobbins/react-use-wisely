...
describe('useWhyDidYouUpdate', () => {
	...
	test('should handle primitive props changes', () => {
		const { rerender } = render(
			<TestComponent primitiveValue="initial" />
		);
		...
		rerender(
			<TestComponent primitiveValue="changed" />
		);
	...
	test('should log when object props change by reference', () => {
		...
		const { rerender } = render(
			<TestComponent objectValue={initialObject} />
		);
		...
		rerender(
			<TestComponent objectValue={newObject} />
		);
	...
	test('should handle added and removed props', () => {
		...
		const { rerender } = render(
			<TestComponent primitiveValue="test" />
		);
