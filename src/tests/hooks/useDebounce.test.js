...
describe('useDebounce', () => {
	test('should initially return the provided value', () => {
		...
		expect(screen.getByTestId('debounced-value').textContent).toBe('initial value');
	});
	...
	test('should update debounced value after delay', () => {
		...
		expect(screen.getByTestId('current-value').textContent).toBe('updated value');
		...
		expect(screen.getByTestId('debounced-value').textContent).toBe('updated value');
	});
});
